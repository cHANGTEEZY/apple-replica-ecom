...
function populateOptions(selectElement, countriesArray) {
...
const defaultCountry = countries.find((c) => c.name === "Nepal");
countrySelect.value = defaultCountry.code;

populatePhoneCodes(defaultCountry.code);
countrySelect.dispatchEvent(new Event("change"));

function populatePhoneCodes(countryCode) {
...
countrySelect.addEventListener("change", () => {
  ...
  populatePhoneCodes(countryCode);
});
